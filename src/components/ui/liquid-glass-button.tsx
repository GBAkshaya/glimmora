...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gold text-ivory hover:bg-gold-dark",
        destructive:
          "bg-red-600 text-white hover:bg-red-600/90",
        cool: "dark:inset-shadow-2xs dark:inset-shadow-white/10 bg-linear-to-t border border-b-2 border-zinc-950/40 from-gold to-gold/85 shadow-md shadow-gold/20 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 text-ivory",
        outline:
          "border border-gold/30 bg-transparent hover:bg-gold/10 hover:text-gold-dark",
        secondary:
          "bg-charcoal text-ivory hover:bg-charcoal/80",
        ghost: "hover:bg-gold/10 hover:text-gold-dark",
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-gold focus-visible:ring-gold/50 focus-visible:ring-[3px] aria-invalid:ring-red-600/20 aria-invalid:border-red-600",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-gold-dark",
        destructive:
